...
public class NamesResource {
	private static Random ranGen = new Random(20);
	...
	public static String[] roadNames = 
		{
				"High Street",
	...
	public static String[] binghamtonMajors = 
		{
	...
	public static List<String> capitalsList = new ArrayList<String>(capitals.keySet());
	...
	private static Course[] courses = {
			...
			new Course(4, "MATH 304 Linear Algebra"),
			new Course(4, "ARTS 210 Graphic Design I"),
			new Course(4, "ECON 162 Principles of Macroecon"),
			new Course(4, "PHYS 132 Gen Physics II Calc"),
			new Course(4, "HIST 130A Modern World History"),
			new Course(4, "ENG 280K Let's Talk About K-pop"),
			new Course(4, "AAAS 280F Culture Politics Asian/Am Food"),
			new Course(4, "HIST 103A Foundations Of America"),
			new Course(4, "ARTH 321 Film Theory"),
			new Course(4, "CINE 250 Animation"),
	};

	static { // static block is executed when class is loaded into memory
