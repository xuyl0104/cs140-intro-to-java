...
public class CompleteBinaryTree<T> {
	 ...
	 */
	public CompleteBinaryTree() { root = null; } 

	/**
	 * Constructs a tree with one node and no children.
	 * @param rootData the data for the root
	 */
	public CompleteBinaryTree(T rootData) {
	 ...
	 */
	public CompleteBinaryTree<T> left() { 
		CompleteBinaryTree<T> result = new CompleteBinaryTree<>();
	 ...
	 */
	public CompleteBinaryTree<T> right() { 
		CompleteBinaryTree<T> result = new CompleteBinaryTree<>();
